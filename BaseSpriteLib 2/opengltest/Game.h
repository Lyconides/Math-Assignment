...
public:
	...
	//Create the sprites for smallAsteroid, largeAsteroid, projectiles
	//Sprite *smallAsteroidDefault;
	//Sprite *largeAsteroidDefault;
	//Sprite *projectilesDefault;
